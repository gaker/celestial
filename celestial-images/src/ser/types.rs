...
impl SerTimestamp {
    ...
    pub fn from_celestial_time(utc: UTC) -> TimeResult<Self> {
...
mod tests {
    ...
    #[test]
    fn ser_timestamp_to_celestial_time_compute() {
    ...
    #[test]
    fn ser_timestamp_ticks_to_celestial_time_valid() {
        let unix_1980_ticks = SerTimestamp::UNIX_EPOCH_TICKS
    ...
    #[test]
    fn ser_timestamp_ticks_to_celestial_time_before_epoch() {
