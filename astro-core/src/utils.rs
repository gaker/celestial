...
///
/// ```
/// use astro_core::utils::jd_to_centuries;
...
/// assert_eq!(jd_to_centuries(J2000_JD, astro_core::constants::DAYS_PER_JULIAN_CENTURY), 1.0);
/// ```
#[inline]
...
///
/// ```
/// use astro_core::utils::angular_difference;
///
/// // Simple case
