...
use astro_core::constants::{J2000_JD, TWOPI};
...
impl GMST {
    ...
    pub fn to_lmst(&self, location: &astro_core::Location) -> crate::sidereal::LMST {
        use super::angle::SiderealAngle;
...
fn calculate_gmst_iau2006(ut1: &UT1, tt: &TT) -> TimeResult<f64> {
    ...
    let t = ((tt_jd1 - J2000_JD) + tt_jd2) / astro_core::constants::DAYS_PER_JULIAN_CENTURY;
    ...
    let gmst = era + polynomial_arcsec * astro_core::constants::ARCSEC_TO_RAD;
...
mod tests {
    ...
    fn test_gmst_constructors_and_accessors() {
        ...
        let gmst_rad = GMST::from_radians(astro_core::constants::PI);
        assert!((gmst_rad.radians() - astro_core::constants::PI).abs() < 1e-15);
