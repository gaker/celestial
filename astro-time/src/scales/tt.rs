...
//!
//! ```
//! use astro_time::{JulianDate, TT};
//!
//! // Create TT at J2000.0 epoch
//! let tt = TT::j2000();
//!
//! // From calendar date
//! use astro_time::scales::tt::tt_from_calendar;
...
impl TT {
    ...
    pub fn centuries_since_j2000(&self) -> f64 {
        (self.0.to_f64() - J2000_JD) / astro_core::constants::DAYS_PER_JULIAN_CENTURY
    }
}
...
mod tests {
    ...
    fn test_tt_julian_year_and_centuries() {
        ...
        let tt_plus_century = tt.add_days(astro_core::constants::DAYS_PER_JULIAN_CENTURY);
