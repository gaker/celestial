...
//!
//! ```
//! use astro_time::scales::{TT, TDB};
//! use astro_time::scales::conversions::{ToTDB, ToTTFromTDB};
//! use astro_time::JulianDate;
...
impl ToTDB for TT {
    ...
    fn to_tdb_with_offset(&self, dtr_seconds: f64) -> TimeResult<TDB> {
        ...
        let dtr_days = dtr_seconds / astro_core::constants::SECONDS_PER_DAY_F64;
...
mod tests {
    use super::*;
    use astro_core::constants::{DAYS_PER_JULIAN_CENTURY, J2000_JD};
