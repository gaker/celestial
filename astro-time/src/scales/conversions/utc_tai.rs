...
mod tests {
    ...
    fn test_utc_tai_round_trip_precision() {
        ...
        let test_cases: &[(f64, f64)] = &[
            ...
            (0.1, astro_core::constants::J2000_JD), // jd2 > jd1 (alternate split in tai_to_utc)
        ];
    ...
    fn test_calendar_helper_functions() {
        ...
        let (y, m, d, frac) = julian_to_calendar(astro_core::constants::J2000_JD, -0.6).unwrap();
