...
//!
//! ```
//! use astro_time::{JulianDate, UT1};
//! use astro_time::scales::ut1::ut1_from_calendar;
//!
...
use astro_core::constants::{NANOSECONDS_PER_SECOND_F64, SECONDS_PER_DAY, SECONDS_PER_DAY_F64};
use std::fmt;
use std::str::FromStr;
