...
pub struct NutationResult {
    core_result: astro_core::nutation::NutationResult,
    model: NutationModel,
}

impl NutationResult {
    pub fn new(core_result: astro_core::nutation::NutationResult, model: NutationModel) -> Self {
...
mod integration_tests {
    ...
    fn test_nutation_epoch_too_far_from_j2000() {
        ...
        let far_future_jd = J2000_JD + (25.0 * astro_core::constants::DAYS_PER_JULIAN_CENTURY);
...
mod utils {
    ...
    pub fn tt_to_centuries(tt: &TT) -> TimeResult<f64> {
        ...
        let centuries = astro_core::utils::jd_to_centuries(jd.jd1(), jd.jd2());
