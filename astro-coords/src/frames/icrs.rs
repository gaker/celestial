...
mod tests {
    ...
    fn test_angular_separation() {
        ...
        astro_core::test_helpers::assert_ulp_le(sep_90.degrees(), 90.0, 2, "90° separation");

        // Test pole separation
        let sep_pole = pos1.angular_separation(&pos3);
        astro_core::test_helpers::assert_ulp_le(sep_pole.degrees(), 90.0, 2, "Pole separation");
