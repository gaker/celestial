...
impl ElpMpp02Moon {
    ...
    fn evaluate(&self, tj: f64) -> (f64, f64, f64, f64, f64, f64) {
        let t = [
            1.0,
            tj / celestial_core::constants::DAYS_PER_JULIAN_CENTURY,
            0.0,
            0.0,
            0.0,
        ];
        ...
        let vx = (pw2 * xp1 + pwqw * xp2 + pwra * xp3 + ppw2 * x1 + ppwqpw * x2 + ppwra * x3)
            / celestial_core::constants::DAYS_PER_JULIAN_CENTURY;
...
mod tests {
    ...
    fn test_velocity_magnitude() {
        ...
        println!(
            ...
            v_num_mag,
            v_num_mag / celestial_core::constants::SECONDS_PER_DAY_F64
        );
