...
use super::SpkError;
use astro_core::constants::{J2000_JD, SECONDS_PER_DAY_F64};
use std::path::Path;
...
mod tests {
    ...
    fn test_spk_segment_from_summary() {
        let summary = DafSummary {
            doubles: vec![0.0, astro_core::constants::SECONDS_PER_DAY_F64], // start and end epoch
        ...
        assert!((segment.end_epoch - astro_core::constants::SECONDS_PER_DAY_F64).abs() < 1e-10);
    }
    ...
    fn test_spk_segment_from_summary_insufficient_ints() {
        let summary = DafSummary {
            doubles: vec![0.0, astro_core::constants::SECONDS_PER_DAY_F64],
    ...
    fn test_spk_segment_clone() {
        let segment = SpkSegment {
            ...
            data_type: 2,
            start_epoch: 0.0,
            end_epoch: astro_core::constants::SECONDS_PER_DAY_F64,
            start_index: 100,
            end_index: 200,
        };
    ...
    fn test_type2_metadata_struct() {
        let meta = Type2Metadata {
            init: 0.0,
            intlen: astro_core::constants::SECONDS_PER_DAY_F64,
            rsize: 50,
            n_records: 100,
            n_coeffs: 16,
        };
        ...
        assert_eq!(meta.intlen, astro_core::constants::SECONDS_PER_DAY_F64);
