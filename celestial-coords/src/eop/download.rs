...
impl EopDownloader {
    pub fn new() -> Self {
        Self {
            ...
            user_agent: format!("celestial-coords/{}", env!("CARGO_PKG_VERSION")),
        }
    }
...
mod tests {
    ...
    fn test_downloader_creation() {
        ...
        assert!(downloader.user_agent.starts_with("celestial-coords/"));
        assert_eq!(
            downloader.user_agent,
            format!("celestial-coords/{}", env!("CARGO_PKG_VERSION"))
        );
    }
